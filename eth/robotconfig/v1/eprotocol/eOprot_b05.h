...
enum { eoprot_b05_as_strains_numberof = 0, eoprot_b05_as_maises_numberof = 0, eoprot_b05_as_extorque_numberof = 1 };
...
/** @fn         extern eOresult_t eoprot_b05_Initialise(void* p, eObool_t islocal)
