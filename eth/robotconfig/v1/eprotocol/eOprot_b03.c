...
EO_VERIFYproposition(eoprot_b03_gasdfe, eoprot_boards_maxnumberof > eoprot_b03_boardnumber);
...
static const eOnvset_EPcfg_t s_eoprot_b03_theEPcfgs[] =
{  
    {   // management
        EO_INIT(.endpoint)                          eoprot_endpoint_management,
        EO_INIT(.dummy)                             0,
        EO_INIT(.epram_sizeof)                      sizeof(eOprot_b03_management_t),
    ...
    {   // motion-control         
        ...
        EO_INIT(.dummy)                             0,
        EO_INIT(.epram_sizeof)                      sizeof(eOprot_b03_motioncontrol_t),
    ...
    {   // analog-sensors         
        ...
        EO_INIT(.dummy)                             0,
        EO_INIT(.epram_sizeof)                      sizeof(eOprot_b03_analogsensors_t),
        EO_INIT(.fptr_ram_initialise)               eoprot_fun_INITIALISE_as        
    }  
    
};  EO_VERIFYsizeof(s_eoprot_b03_theEPcfgs, sizeof(eOnvset_EPcfg_t)*(eoprot_b03_endpoints_numberof));



static const EOconstvector s_eoprot_b03_constvectofEPcfg = 
{
    EO_INIT(.size)                  sizeof(s_eoprot_b03_theEPcfgs)/sizeof(const eOnvset_EPcfg_t),
    EO_INIT(.item_size)             sizeof(eOnvset_EPcfg_t),
    EO_INIT(.item_array_data)       s_eoprot_b03_theEPcfgs
};
...
const eOnvset_DEVcfg_t eoprot_b03_nvsetDEVcfg =
{
...
const uint8_t eoprot_b03_mn_entities_numberofeach[eomn_entities_numberof] = 
{ 
    eoprot_b03_mn_comms_numberof, 
    eoprot_b03_mn_appls_numberof,
    eoprot_b03_mn_infos_numberof
};

const uint8_t eoprot_b03_mc_entities_numberofeach[eomc_entities_numberof] = 
{ 
    eoprot_b03_mc_joints_numberof, 
    eoprot_b03_mc_motors_numberof, 
    eoprot_b03_mc_controllers_numberof
};

const uint8_t eoprot_b03_as_entities_numberofeach[eoas_entities_numberof] = 
{ 
    eoprot_b03_as_strains_numberof, 
    eoprot_b03_as_maises_numberof,
    eoprot_b03_as_extorque_numberof
};
...
extern eOresult_t eoprot_b03_Initialise(void* p, eObool_t islocal)
{
    ...
    eoprot_config_endpoint_entities(eoprot_b03_boardnumber, eoprot_endpoint_management, eoprot_b03_mn_entities_numberofeach);
...
EO_VERIFYproposition(s_eoprot_b03_mn_val, 0 == eoprot_endpoint_management);
EO_VERIFYproposition(s_eoprot_b03_mc_val, 1 == eoprot_endpoint_motioncontrol);
