...
enum { eoprot_b04_as_strains_numberof = 0, eoprot_b04_as_maises_numberof = 1, eoprot_b04_as_extorque_numberof = 1 };
...
/** @fn         extern eOresult_t eoprot_b04_Initialise(void* p, eObool_t islocal)
