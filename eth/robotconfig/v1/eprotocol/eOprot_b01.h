...
enum { eoprot_b01_mn_comms_numberof = 1, eoprot_b01_mn_appls_numberof = 1, eoprot_b01_mn_infos_numberof = 1 };
...
typedef struct                  // 124+24+40 = 168              
{
    ...
    eOmn_info_t                 info;
} eOprot_b01_management_t;      //EO_VERIFYsizeof(eOprot_b01_management_t, 168); 
...
enum { eoprot_b01_as_strains_numberof = 1, eoprot_b01_as_maises_numberof = 0, eoprot_b01_as_extorque_numberof = 1 };
...
/** @fn         extern eOresult_t eoprot_b01_Initialise(void* p, eObool_t islocal)
...
/** @fn         extern eObool_t eoprot_b01_isvariableproxied(eOnvID32_t id)
 ...
 **/
extern eObool_t eoprot_b01_isvariableproxied(eOnvID32_t id);
