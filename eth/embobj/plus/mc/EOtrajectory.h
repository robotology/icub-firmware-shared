...
extern void eo_trajectory_SetPosReference(EOtrajectory *o, int32_t p0, int32_t p1, int32_t avg_vel);
...
/** @fn         extern void eo_trajectory_Abort(EOtrajectory *o)
    ...
    @param      o  The pointer to the trajectory object.
 **/
extern void eo_trajectory_Stop(EOtrajectory *o, int32_t pos);
