...
// - include guard ----------------------------------------------------------------------------------------------------
#ifndef _EOCANPROTOCOLMCPERIODIC_H_
#define _EOCANPROTOCOLMCPERIODIC_H_
...
/** @file       EoCANprotocolMCperiodic.h
    @brief      This header file contains declaration of the functions used to parse / form can frames related to 
                motion control periodic messages
    @author     marco.accame@iit.it
	@date       12 mar 2015
**/

/** @defgroup eo_EoCANprotocolMCperiodic CAN protocol for MC periodic messages
...
/** @}            
    end of group eo_EoCANprotocolMCperiodic  
 **/
