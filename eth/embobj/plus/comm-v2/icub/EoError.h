...
enum { eoerror_category_numberof = 6 };
...
/** @typedef    typedef enum eOerror_value_CFG_t
    @brief      it contains the values of the eoerror_category_ApplConfiguration category. In case you need a new value: add it
                in consecutive mode without holes and increment eoerror_value_CFG_numberof. In case you need to remove a value, dont
                remove the number but simply rename it: that will help detecting old boards sending pairs {category, value} not supported yet.  
 **/
typedef enum
{
