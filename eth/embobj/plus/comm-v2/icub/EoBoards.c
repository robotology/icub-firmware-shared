...
{    
    ...
    {"P3P2", "eobrd_conn_P3P2", eobrd_conn_P3P2},
    {"P4P5", "eobrd_conn_P4P5", eobrd_conn_P4P5},
...
{//  shortname  longname          port value        boardtype   connector  
    ...
    {"mc4plusP3P2", "eobrd_port_mc4plusP3P2", eobrd_port_mc4plusP3P2, eobrd_mc4plus, eobrd_conn_P3P2},
    {"mc4plusP4P5", "eobrd_port_mc4plusP4P5", eobrd_port_mc4plusP4P5, eobrd_mc4plus, eobrd_conn_P4P5},    
