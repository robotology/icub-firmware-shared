...
const eomcconfig_codeconfig_t eomcconfig_codeconfig_MC4PLUS[] =
{
    ...
    {EO_INIT(.value) eOmcconfig_value_MC4PLUS_b7,
        EO_INIT(.jomos[0].actuator.local.type)  1, EO_INIT(.jomos[0].actuator.local.index) 0, EO_INIT(.jomos[0].encoder.etype)  0, EO_INIT(.jomos[0].encoder.index)  1, // j0-> jaw, motor1, incremental-encoder
        EO_INIT(.jomos[1].actuator.local.type)  1, EO_INIT(.jomos[1].actuator.local.index) 1, EO_INIT(.jomos[1].encoder.etype)  0, EO_INIT(.jomos[1].encoder.index)  0 // j1-> eyelids, motor3, incremental-encoder
