...
typedef struct                  // size is 112+36+8+32+0 = 188
{
 ...
 **/
typedef struct                  // size is: 24+4+2+2+0 = 32
{
    ...
    uint8_t                     filler02[2];                
} eOmc_motor_config_t;          //EO_VERIFYsizeof(eOmc_motor_config_t, 32);
...
typedef struct                  // size is 32+16+0 = 48
{
