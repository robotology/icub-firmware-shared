...
{   // very important: fill table with order of eOerror_value_CFG_t
    ...
    {eoerror_value_CFG_mc_advfoc_ICCdiscovery_invalid, "CFG: ICCdiscovery detected on ","In par64: the nibble contains 0x0 if ok, mask 0x1 if wrong type, mask 0x2 if wrong fw, mask 0x4 if wrong prot"}
