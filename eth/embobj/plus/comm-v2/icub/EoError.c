...
{   // very important: fill table with order of eOerror_value_SYS_t
    ...
    {eoerror_value_SYS_canservices_rxfifooverflow, "SYS: the HAL could not put a CAN frame in rx fifo."}, //NOT USED in FW In par16 there is: on msb the rx fifo size, in lsb a code."},
    ...
    {eoerror_value_SYS_ctrloop_rxphaseaverage, 	 "SYS: RX phase of the control loop average execution time in usec, monitored for the last 10secs, is "}, //stored in par16 "},
	{eoerror_value_SYS_ctrloop_dophaseaverage, 	 "SYS: DO phase of the control loop average execution time in usec, monitored for the last 10secs, is"}, // stored in par16 "},
	{eoerror_value_SYS_ctrloop_txphaseaverage, 	 "SYS: TX phase of the control loop average execution time in usec, monitored for the last 10secs, is "}, // stored in par16 "},
    {eoerror_value_SYS_ctrloop_rxphasemax, 	     "SYS: RX phase of the control loop max execution time in usec, monitored for the last 10secs, is "}, //stored in par16 "},
	{eoerror_value_SYS_ctrloop_dophasemax, 	     "SYS: DO phase of the control loop max execution time in usec, monitored for the last 10secs, is "}, //stored in par16 "},
	{eoerror_value_SYS_ctrloop_txphasemax, 	     "SYS: TX phase of the control loop max execution time in usec, monitored for the last 10secs, is "}, //stored in par16 "},
    {eoerror_value_SYS_ctrloop_rxphasemin, 	     "SYS: RX phase of the control loop min execution time in usec, monitored for the last 10secs, is "}, //stored in par16 "},
	{eoerror_value_SYS_ctrloop_dophasemin, 	     "SYS: DO phase of the control loop min execution time in usec, monitored for the last 10secs, is "}, //stored in par16 "},
	{eoerror_value_SYS_ctrloop_txphasemin, 	     "SYS: TX phase of the control loop min execution time in usec, monitored for the last 10secs, is "}, //stored in par16 "},
    ...
    {eoerror_value_SYS_proxy_reply_fails,        "SYS: the proxy fails to forward a request."}, // NOT USED  in par64 there are the [sign|id32], in par16 [capacity|size] of proxy list. if par16 is 0, then the rop could not be tx."},
    ...
    {eoerror_value_SYS_canservices_boards_searched, "SYS: the can discovery service searched the following boards on the specified CAN bus."}, //NOT USED In par64 there are the searched addresses represented as nibbles."},    
    {eoerror_value_SYS_canservices_boards_found, "SYS: the can discovery service found the following boards on the specified CAN bus."}, //NOT USED In par64 there are the found addresses represented as nibbles."},
...
{   // very important: fill table with order of eOerror_value_CFG_t
    ...
    {eoerror_value_CFG_skin_failed_candiscovery, "CFG: EOtheSKIN cannot be configured. CANdiscovery fails"}, // num of patches in p16. in p64 from lsb to msb masks of: missing can1, can2, found but incompatible can1, can2"},
    ...
    {eoerror_value_CFG_strain_failed_candiscovery, "CFG: EOtheSTRAIN cannot be configured. CANdiscovery fails"}, //can address in p16, prot and vers in p64 lower 32 bits. Byte 5 of p64: 0x01 is strain, 0x02 is strain2"},
    ...
    {eoerror_value_CFG_mais_failed_candiscovery, "CFG: EOtheMAIS cannot be configured. CANdiscovery fails"},// can address in p16, prot and vers in p64 lower 32 bits"},
    {eoerror_value_CFG_mais_failed_verify_because_active, "CFG: EOtheMAIS cannot be configured. it was already activated with different configuration."}, // no need to modify
    {eoerror_value_CFG_mc_foc_ok, "CFG: EOtheMotionController can correctly configure 2foc-based motion. more info will follow"}, // no need to modify
    {eoerror_value_CFG_mc_foc_failed_candiscovery_of_foc, "CFG: EOtheMotionController cannot be configured. CANdiscovery of 2foc boards fails. see CANdiscovery messages for more details"}, // no need to modify
    {eoerror_value_CFG_mc_foc_failed_encoders_verify, "CFG: EOtheMotionController cannot be configured. verification of encoders fails. see other messages for more details"}, // no need to modify
    {eoerror_value_CFG_mc_mc4_ok, "CFG: EOtheMotionController can correctly configure mc4-based motion. more info will follow"}, // no need to modify
    {eoerror_value_CFG_mc_mc4_failed_candiscovery_of_mc4, "CFG: EOtheMotionController cannot be configured. can discovery of mc4 boards fails. see CANdiscovery messages for more details"}, // no need to modify
    {eoerror_value_CFG_mc_mc4_failed_mais_verify, "CFG: EOtheMotionController cannot be configured. verification of mais fails. see other messages for more details"}, // no need to modify
    {eoerror_value_CFG_mc_mc4plus_ok, "CFG: EOtheMotionController can correctly configure mc4plus-based motion. more info will follow"}, // no need to modify
    {eoerror_value_CFG_mc_mc4plus_failed_encoders_verify, "CFG: EOtheMotionController cannot be configured. verification of encoder fails. see other messages for more details"}, // no need to modify
    ...
    {eoerror_value_CFG_inertials_failed_candiscovery, "CFG: EOtheInertial cannot be configured. CANdiscovery fails"},// in p64 from lsb to msb masks of: missing can1, can2, found but incompatible can1, can2"},
    
    {eoerror_value_CFG_comm_cannotloadaregularrop, "CFG: cannot load a regular rop."},//tbd"},

    {eoerror_value_CFG_mc_mc4plusmais_ok, "CFG: EOtheMotionController can correctly configure mc4plusmais-based motion. more info will follow"}, //no need to modify
    {eoerror_value_CFG_mc_mc4plusmais_failed_encoders_verify, "CFG: EOtheMotionController cannot be configured. verification of encoder fails for mc4plusmais. see other messages for more details"}, //no need to modify
    {eoerror_value_CFG_mc_mc4plusmais_failed_candiscovery_of_mais, "CFG: EOtheMotionController cannot be configured. verification of mais for mc4plusmais fails. see other messages for more details"}, //no need to modify
    
    {eoerror_value_CFG_services_not_verified_yet, "CFG: EOtheServices has not yet finished verifying the required services. restart robotInterface."}, //no need to modify
    {eoerror_value_CFG_mc_not_verified_yet, "CFG: EOtheMotionController service was not verified yet, thus it cannot start."},//no need to modify
    {eoerror_value_CFG_strain_not_verified_yet, "CFG: EOtheSTRAIN service was not verified yet, thus it cannot start."},//no need to modify
    {eoerror_value_CFG_mais_not_verified_yet, "CFG: EOtheMAIS service was not verified yet, thus it cannot start."},//no need to modify
    {eoerror_value_CFG_skin_not_verified_yet, "CFG: EOtheSKIN service was not verified yet, thus it cannot start."},//no need to modify
    {eoerror_value_CFG_inertials_not_verified_yet, "CFG: EOtheInertials service was not verified yet, thus it cannot start."},//no need to modify
    {eoerror_value_CFG_inertials3_not_verified_yet, "CFG: EOtheInertials3 service was not verified yet, thus it cannot start."},//no need to modify
    {eoerror_value_CFG_encoders_not_verified_yet, "CFG: EOtheEncoderReader service was not verified yet, thus it cannot start."},//no need to modify
    {eoerror_value_CFG_mc_using_onboard_config, "CFG: EOtheMotionController service is using the local default configuration based on its IP address."},//no need to modify
    {eoerror_value_CFG_strain_using_onboard_config, "CFG: EOtheSTRAIN service is using the local default configuration based on its IP address."},//no need to modify
    {eoerror_value_CFG_mais_using_onboard_config, "CFG: EOtheMAIS service is using the local default configuration based on its IP address."},//no need to modify
    {eoerror_value_CFG_inertials_using_onboard_config, "CFG: EOtheInertials service is using the local default configuration based on its IP address."},//no need to modify
    {eoerror_value_CFG_inertials3_using_onboard_config, "CFG: EOtheInertials3 service is using the local default configuration based on its IP address."},//no need to modify
    {eoerror_value_CFG_skin_using_onboard_config, "CFG: EOtheSKIN service is using the local default configuration based on its IP address."},//no need to modify
    ...
    {eoerror_value_CFG_inertials3_failed_candiscovery, "CFG: EOtheInertial3 cannot be configured. CANdiscovery fails"},//. in p64 from lsb to msb masks of: missing can1, can2, found but incompatible can1, can2"},
    {eoerror_value_CFG_inertials3_failed_generic, "CFG: EOtheInertial3 cannot be configured. generic error"},// more details in p16 and p64 and in source code"},//recheck
    ...
    {eoerror_value_CFG_temperatures_failed_candiscovery, "CFG: EOtheTemperatures cannot be configured. CANdiscovery fails"},//. in p64 from lsb to msb masks of: missing can1, can2, found but incompatible can1, can2"},
    ...
    {eoerror_value_CFG_temperatures_using_onboard_config, "CFG: EOtheTemperatures service is using the local default configuration based on its IP address."}, //no need to modify
    
    {eoerror_value_CFG_psc_ok, "CFG: EOthePSC can be correctly configured"},//. can address in p16, prot and vers in p64 lower 32 bits"},
    {eoerror_value_CFG_psc_failed_candiscovery, "CFG: EOthePSC cannot be configured. CANdiscovery fails"},//. can address in p16, prot and vers in p64 lower 32 bits"},
    {eoerror_value_CFG_psc_failed_verify_because_active, "CFG: EOthePSC cannot be configured. it was already activated with different configuration."},//no need to modify
    {eoerror_value_CFG_psc_not_verified_yet, "CFG: EOthePSC service was not verified yet, thus it cannot start."},  //no need to modify
    {eoerror_value_CFG_psc_using_onboard_config, "CFG: EOthePSC service is using the local default configuration based on its IP address."},    //no need to modify
    ...
    {eoerror_value_CFG_mc_mc2pluspsc_ok, "CFG: EOtheMotionController can correctly configure mc2pluspsc-based motion. more info will follow"}, //no need to modify
    {eoerror_value_CFG_mc_mc2pluspsc_failed_encoders_verify, "CFG: EOtheMotionController cannot be configured. verification of encoder fails for mc2pluspsc. see other messages for more details"},//no need to modify
    {eoerror_value_CFG_mc_mc2pluspsc_failed_candiscovery_of_pscs, "CFG: EOtheMotionController cannot be configured. verification of pscs for mc2pluspsc fails. see other messages for more details"},//no need to modify
    ...
    {eoerror_value_CFG_pos_failed_candiscovery, "CFG: EOthePOS cannot be configured. CANdiscovery fails"},//. can address in p16, prot and vers in p64 lower 32 bits"},
