...
extern EOPROT_ROMmap EOnv_rom_t * const eoprot_mc_rom_folded_descriptors[];
...
extern const void* const eoprot_mc_rom_entities_defval[eoprot_entities_mc_numberof];
