...
{    
    ...
    {   // not enough space in ...
        char msg[64] = "";
        sprintf(msg, "Not enough space in ropframe reply:  %d, %d, %d, %d, %d, %d", p->capacity, p->size, p->framedata->header.ropsnumberof, p->framedata->header.ropsnumberof, remaining, streamsize);
